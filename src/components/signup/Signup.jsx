        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="p-8">
            ...
            <form onSubmit={handleOnSubmit}>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-bold py-3 px-4 rounded-lg mt-6 hover:from-purple-600 hover:to-indigo-700 transition duration-300 transform hover:-translate-y-1 hover:shadow-lg"
              >
                Sign Up
              </motion.button>
            </form>
          ...
          <div className="px-8 py-4 bg-gray-50 border-t border-gray-100">
            <p className="text-center text-gray-600">
              ...
              <Link to="/login" className="text-indigo-600 font-medium hover:text-indigo-500 transition duration-200">
                Log in
              </Link>
            </p>
          </div>
